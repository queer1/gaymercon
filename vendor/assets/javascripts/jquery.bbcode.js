    ...
    $.fn.bbcode = function () {
        ...
        return this.each(function () {
            ...
            if ($this.is('textarea')) {
                ...
                $editor.find('.bbcode-youtube').bind('click', function () {
                    var url = prompt('Enter a YouTube url', 'http://www.youtube.com/watch?v=UPZ-D6gX9tc');
                    if (!url) { return; }

                    $cloned_textarea.replaceSelectedText('[youtube]' + url + '[/youtube]', 0, true);
                    $cloned_textarea.focus()                    
                });
